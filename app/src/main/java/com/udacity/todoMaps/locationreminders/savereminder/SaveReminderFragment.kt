package com.udacity.todoMaps.locationreminders.savereminder
...
import com.udacity.todoMaps.BuildConfig
...
import com.udacity.todoMaps.databinding.FragmentSaveReminderBinding
import com.udacity.todoMaps.locationreminders.geofence.GeofenceBroadcastReceiver
import com.udacity.todoMaps.locationreminders.reminderslist.ReminderDataItem
...
//             2) save the reminder to the local db
    ...
    private fun addGeofenceOfReminderAndSaveIt(reminderDataItem: ReminderDataItem) {
    ...
    */
    private fun checkDeviceLocationSettingsAndStartGeofence(resolve:Boolean = true) {
        ...
        locationSettingsResponseTask.addOnCompleteListener {
            if ( it.isSuccessful ) {
                addGeofenceOfReminderAndSaveIt(reminderDataItem)
            }
        }
    }
