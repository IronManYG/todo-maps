...
//    : add End to End testing to the app
    ...
    fun saveReminder_andChickItINRemindersList(){
        ...
        onView(withId(R.id.save_ponit_of_interest)).perform(click())
        onView(withId(R.id.saveReminder)).perform(click())

        // 3. Verify it was save.
